...
module.exports.patchServeCommand = function patchServeCommand(cliVersion) {
  ...
  if (semver.satisfies(cliVersion, '>=6.0.0')) {
    /**
    ...
    const ServeCommand = require('../../../@angular/cli/commands/serve');
    require.cache['@angular/cli/commands/serve'] = require('../../../@angular/cli/commands/serve');

    class PatchedServeCommand extends ServeCommand.default {
      run(commandOptions) {
    ...
    ServeCommand.default = PatchedServeCommand;
  } else {
