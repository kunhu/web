...
function extractNGServerRunning(text) {
  ...
  const serverIsRunning = /NG Live Development Server is running|NG Live Development Server is listening|Angular Live Development Server/;
...
function extractBuildFinished(text) {
  let buildEvent = null;
  const webpackBuildFinished = /webpack: bundle is now VALID|webpack: Compiled successfully.|webpack: Failed to compile.|Compiled successfully./;
