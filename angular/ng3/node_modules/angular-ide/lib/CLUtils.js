...
function injectCLBootstrapScript(ngCLIVersion, config) {
  ...
  if (semver.satisfies(ngCLIVersion, '>=6.0.0')) {
...
function injectCLBootstrapScript_3(ngCLIVersion, config) {
  const htmlPlugin = require('../../@angular-devkit/build-angular/src/angular-cli-files/plugins/index-html-webpack-plugin');
  ...
  class PatchedIndexHTMLWebpackPlugin extends htmlPlugin.IndexHtmlWebpackPlugin {
    apply(compiler) {
      ...
      compiler.hooks.emit.tapPromise('index-html-webpack-plugin', (compilation) => {
        return new Promise((resolve, reject) => {
          if (CLEnablementStatusManager.getStatus()) {
            const patchedContents = compilation.assets[this._options.output].source()
            ...
            compilation.assets[this._options.output] = {
              source: function () {
  ...
  htmlPlugin.IndexHtmlWebpackPlugin = PatchedIndexHTMLWebpackPlugin;
